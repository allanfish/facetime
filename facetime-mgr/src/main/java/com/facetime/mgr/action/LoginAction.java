...
import com.facetime.spring.action.BaseAction;
...
public class LoginAction extends BaseAction {
	...
	public String checkuser(HttpServletRequest request, EmployeeBean loginForm, ModelMap model) throws Exception {
		...
		switch (result) {
		case NO_USERNAME:
			model.addAttribute("message", SpringContextUtils.message("index.checkForm.loginName"));
			break;
		case NO_PWD:
			model.addAttribute("message", SpringContextUtils.message("index.checkForm.password"));
			break;
		case USER_NOT_VALID:
			model.addAttribute("message", SpringContextUtils.message("loginAction.user.invalid"));
			break;
		case USER_NOT_EXISTS:
			model.addAttribute("message", SpringContextUtils.message("loginAction.user.notexist"));
			break;
		case PWD_IS_EXPIRED:
			model.addAttribute("message", SpringContextUtils.message("loginAction.password.unsafe"));
		...
		case PWD_NOT_CORRECT:
			model.addAttribute("message", SpringContextUtils.message("loginAction.password.unfit"));
			user = defaultLogic.findById(SysUser.class, loginForm.getUsername());
