...
public class HttpSender {
	...
	public static final String buildGetErrorMsg(String token, String resturl, String search, String result) {
		return buildMsg(false, false, token, resturl, search, result);
	}

	public static final String buildMsg(boolean isOK, boolean isPOST, String token, String resturl, String search,
			String result) {
		search = search != null ? search : "";
		return String.format("[%s]-[%s]! [serviceUri:%s] ! [token:%s]-[search:%s] ! [result]: %s ", isPOST ? "postToUrl"
				: "getFromUrl", isOK ? "OK" : "Fail", resturl, token, search, result);
	}

	public static final String buildGetOKMsg(String token, String resturl, String search, String result) {
		return buildMsg(true, false, token, resturl, search, result);
	}

	public static final String buildPostErrorMsg(String token, String resturl, String json, String result) {
		return buildMsg(false, true, token, resturl, json, result);
	}

	public static final String buildPostOKMsg(String token, String resturl, String json, String result) {
		return buildMsg(true, true, token, resturl, json, result);
	}
